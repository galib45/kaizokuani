...
import com.galib.kaizokuani.EpisodeLink
import com.galib.kaizokuani.JsonParser
import com.galib.kaizokuani.ShowInfo
import com.galib.kaizokuani.VideoPlayer
import com.galib.kaizokuani.components.AnimeInfoCardComponent
import com.galib.kaizokuani.components.DialogComponent
import com.galib.kaizokuani.components.DialogListPickerComponent
import com.galib.kaizokuani.components.EpisodesComponent
import com.galib.kaizokuani.components.LoadingDialogComponent
import com.galib.kaizokuani.components.LoadingPageComponent
import com.galib.kaizokuani.decodeSourceUrl
import com.galib.kaizokuani.downloadFile
import com.galib.kaizokuani.extractWixmpLinks
...
fun AnimeDetailsScreen(
    ...
    if (animeDetails.id == null) Text(text = "Invalid anime id")
    ...
    info?.let { info ->
        ...
        if (screenState == ScreenState.CHOOSE_QUALITY) {
            DialogListPickerComponent("Select Quality", qualities, onSelect = { index ->
                ...
                screenState = ScreenState.WAIT_FOR_ACTION
                when(action) {
                    Action.PLAY -> navController.navigate(route = VideoPlayer(url = url, title=filename))
